...
UPDATE Department SET DSSN = 1 WHERE DNum = 1;  -- Ali مدير HR
UPDATE Department SET DSSN = 2 WHERE DNum = 2;  -- Sara مدير IT
UPDATE Department SET DSSN = 3 WHERE DNum = 3;  -- Omar مدير Finance
UPDATE Department SET DSSN = 4 WHERE DNum = 4;  -- Noura مدير Design
SELECT d.DNum,
       d.DName,
       d.DSSN,
